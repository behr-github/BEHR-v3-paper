function [ SumWeightedColumn, SumWeight, Count ] = BEHR_day_no2_v2( OMI, varargin )
%BEHR_DAY_NO2 - handles the weighting of a day's worth of BEHR data
%
%   THIS IS THE LEGACY COMPATIBILITY FUNCTION FOR BEHR V2.1A THROUGH C. 
...
for a=1:numel(OMI)
    ...
    if usebehr
        omi = omi_pixel_reject_v2(omi, cloud_prod, cloud_frac_max, row_anomaly, rows, sza); %We will set the area weight to 0 for any elements that should not contribute to the average
    else
