function [ omi ] = omi_pixel_reject_v2( omi_in, cloud_type, cloud_frac, rowanomaly_mode, rows, szalim )
...
xx = omi_rowanomaly_v2(omi,rowanomaly_mode); %Remove elements affected by the row anomaly.
omi.Areaweight(xx) = 0;
