function varargout = aerosol_no2_prof_gui(varargin)
% AEROSOL_NO2_PROF_GUI MATLAB code for aerosol_no2_prof_gui.fig
%      AEROSOL_NO2_PROF_GUI, by itself, creates a new AEROSOL_NO2_PROF_GUI or raises the existing
%      singleton*.
%
%      H = AEROSOL_NO2_PROF_GUI returns the handle to a new AEROSOL_NO2_PROF_GUI or the handle to
%      the existing singleton*.
%
%      AEROSOL_NO2_PROF_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AEROSOL_NO2_PROF_GUI.M with the given input arguments.
%
%      AEROSOL_NO2_PROF_GUI('Property','Value',...) creates a new AEROSOL_NO2_PROF_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before aerosol_no2_prof_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to aerosol_no2_prof_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help aerosol_no2_prof_gui

% Last Modified by GUIDE v2.5 07-Apr-2015 10:09:47
...
if handles.curr_row > 0
    ...
    fprintf('newgui: No row currently selected\n')
end
